...
* The original package name 'ro.digitalNation.fm.shopManagementProject-server' is invalid and this project uses 'ro.digitalNation.fm.shopManagementProjectserver' instead.
